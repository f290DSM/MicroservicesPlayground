...
import dev.sdras.microservices.core.recommendation.persistence.RecommendationEntity;
import dev.sdras.microservices.core.recommendation.persistence.RecommendationRepository;
...
public class RecommendationServiceImpl implements RecommendationService {
  ...
  public List<Recommendation> getRecommendations(int productId) {
    ...
    list.forEach(e -> e.setServiceAddress(serviceUtil.getServerAddress()));
